...

{
...

    {
...

        {
            ...
            // Scan the uploaded file for file type and viruses using ClamAV

            ClamScan scan = new ClamScan("localhost", 3310);

            bool isClean = scan.ScanFile(filePath);

            if (!isClean)

            {

                // If the file is infected, delete it and display an error message

                System.IO.File.Delete(filePath);

                UploadStatusLabel.Text = "The uploaded file contains a virus or other malicious content and cannot be uploaded.";
